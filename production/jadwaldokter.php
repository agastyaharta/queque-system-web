...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/png" href="images/icon_hospital_1.png">
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Jadwal Dokter <small>Leemoco</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Perhatikan data dengan baik <code>$().TabelDokter();</code>
                    </p>
    ...
    <script src="../build/js/custom.min.js"></script>
     ...
     $(document).ready(function() {
				var dataTable = $('#lookup').DataTable( {
					...
					"serverSide": true,
					"ajax":{
						url :"dokterlist.php", // json datasource
